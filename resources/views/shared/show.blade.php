        ...
        <div class="card content-card">
            <div class="card-body">
                    ...
                    <div class="col-12 col-lg-6">
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2">{{ $shared->shared_type }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Location</td>
                                <td class="px-2 py-2">{{ $shared->location->name }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Provider</td>
                                <td class="px-2 py-2">{{ $shared->provider->name }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2">{{ ($shared->was_promo === 1) ? 'Yes' : 'No' }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-12 col-lg-6">
                        <table class="table table-borderless mb-0">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-2">{{ $shared->disk_as_gb }} GB</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Bandwidth</td>
                                <td class="px-2 py-2">{{ $shared->bandwidth }} GB</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Domains Limit</td>
                                <td class="px-2 py-2">{{ $shared->domains_limit }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Subdomains Limit</td>
                                <td class="px-2 py-2">{{ $shared->subdomains_limit }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">Email Limit</td>
                                <td class="px-2 py-2">{{ $shared->email_limit }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">DB Limit</td>
                                <td class="px-2 py-2">{{ $shared->db_limit }}</td>
                            </tr>
                            <tr>
                                <td class="px-2 py-2 text-muted">FTP Limit</td>
                                <td class="px-2 py-2">{{ $shared->ftp_limit }}</td>
                            </tr>
                            <tr>
                ...
                <small class="text-muted">
                    ID: <code>{{ $shared->id }}</code> |
                    Created: {{ $shared->created_at !== null ? date_format(new DateTime($shared->created_at), 'jS M Y, g:i a') : '-' }} |
