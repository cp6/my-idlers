                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-6 col-md-4 col-lg-2">
                            ...
                            <input type="number" class="form-control" name="bandwidth" id="bandwidth" value="{{ $reseller->bandwidth }}" min="0" max="999999" {{ $reseller->bandwidth == 0 ? 'readonly' : '' }}>
                            <div class="form-check mt-1">
                                <input class="form-check-input" type="checkbox" id="bandwidth_unlimited" {{ $reseller->bandwidth == 0 ? 'checked' : '' }} onchange="var el=document.getElementById('bandwidth');if(this.checked){el.value=0;el.readOnly=true;}else{el.readOnly=false;el.value=500;}">
