...
<x-app-layout>
    <div class="container">
        <div class="page-header">
            <h2 class="page-title">Add Reseller Hosting</h2>
        ...
        <form action="{{ route('reseller.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-6 col-md-4 col-lg-2">
                            ...
                            <input type="number" class="form-control" name="accounts" value="10" min="0" max="999999">
                        </div>
                        <div class="col-6 col-md-4 col-lg-2">
            ...
            <button type="submit" class="btn btn-primary mb-4">Add Reseller Hosting</button>
        </form>
    </div>
</x-app-layout>
