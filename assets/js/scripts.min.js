...
$(document).ready(function () {
    ...
    $("#sharesHostingForm").submit(function (e) {
        e.preventDefault(e);
        $.ajax({
            type: "POST",
            url: "calls.php",
            data: $("#sharesHostingForm").serialize(),
            success: function (result) {
                location.reload();
            }
        });
    ...
    $("#editSharedHostingForm").submit(function (e) {
        e.preventDefault();
        console.log($('#editSharedHostingForm').serialize());
        $.ajax({
            type: "POST",
            url: "calls.php",
            data: $('#editSharedHostingForm').serialize(),
            success: function () {
    ...
    $("#editDomainForm").submit(function (e) {
        e.preventDefault();
        console.log($('#editDomainForm').serialize());
        $.ajax({
            type: "POST",
            url: "calls.php",
            data: $('#editDomainForm').serialize(),
            success: function () {
                window.location.href = window.location.href;
            }
        });
    ...
    $("#editServerModal").submit(function (e) {
        e.preventDefault();
        console.log($('#editServerModal').serialize());
        $.ajax({
            type: "POST",
            url: "calls.php",
    ...
    //Compare section
    $("#compare_s1").change(function () {
        var server1_id = $("#compare_s1 option:selected").val();
        var server2_id = $("#compare_s2 option:selected").val();
        if (server2_id.length !== 0) {
            compareTableCall(server1_id, server2_id);
        }
    });
    $("#compare_s2").change(function () {
        var server2_id = $("#compare_s2 option:selected").val();
        var server1_id = $("#compare_s1 option:selected").val();
        if (server1_id.length !== 0) {
            compareTableCall(server1_id, server2_id);
        }
    });
...
function compareTableCall(id1, id2) {
    $("#compareTableDiv").empty();
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "compare_table", "server1": id1, "server2": id2},
        success: function (result) {
            $("#compareTableDiv").append(result);
        }
    });
}
...
$(function () {
    $(".location-input").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: "calls.php",
                data: {"type": "autocomplete", "input": "location", value: request.term},
                dataType: "json",
                success: response,
            });
        }
    ...
    $(".provider-input").autocomplete({
        source: function (request, response) {
            $.ajax({
                url: "calls.php",
                data: {"type": "autocomplete", "input": "provider", value: request.term},
                dataType: "json",
                success: response,
            });
        }
...
$(document).on("click", "#viewMoreServer", function () {
    ...
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "view_more_modal", "value": "server", "id": serverId},
        success: function (result) {
            $("#viewMoreModalBody").append(result);
        }
    });
});

$(document).on("click", "#viewMoreSharedHosting", function () {
    var serverId = this.getAttribute("value");
    $("#viewMoreSharedHostingModalBody").empty();
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "view_more_modal", "value": "shared", "id": serverId},
        success: function (result) {
            $("#viewMoreSharedHostingModalBody").append(result);
        }
    });
});

$(document).on("click", "#viewMoreDomain", function () {
    var serverId = this.getAttribute("value");
    $("#viewMoreDomainModalBody").empty();
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "view_more_modal", "value": "domain", "id": serverId},
        success: function (result) {
            $("#viewMoreDomainModalBody").append(result);
        }
    });
});
...
$(document).on("click", "#editServer", function () {
    var serverId = this.getAttribute("value");
    modalServerEdit(serverId);
});

$(document).on("click", "#editSharedHosting", function () {
    var serverId = this.getAttribute("value");
    modalEditSharedHosting(serverId);
});

$(document).on("click", "#editDomain", function () {
    var serverId = this.getAttribute("value");
    modalEditDomain(serverId);
});

$(document).on("click", "#viewYabs", function () {
    $('#viewMoreModal').modal('toggle');
    var hostname = $('#view_more_header').text();
    var serverId = this.getAttribute("value");
    yabsModalView(hostname, serverId);
});

$(document).on("click", "#addServerBTN", function () {
    $("#addServer").addClass("show");
    $("#addServerNoYabs").removeClass("show");
    $("#addSharedHosting").removeClass("show");
    $("#addDomain").removeClass("show");
});

$(document).on("click", "#addServerNoYabsBTN", function () {
    $("#addServerNoYabs").addClass("show");
    $("#addServer").removeClass("show");
    $("#addSharedHosting").removeClass("show");
    $("#addDomain").removeClass("show");
});

$(document).on("click", "#addSharedHostingBTN", function () {
    $("#addSharedHosting").addClass("show");
    $("#addServer").removeClass("show");
    $("#addServerNoYabs").removeClass("show");
    $("#addDomain").removeClass("show");
});

$(document).on("click", "#addDomainBTN", function () {
    $("#addDomain").addClass("show");
    $("#addServer").removeClass("show");
    $("#addServerNoYabs").removeClass("show");
    $("#addSharedHosting").removeClass("show");
});
...
function modalServerEdit(id) {
    $.ajax({
        ...
        success: function (result) {
            ...
            $("#me_ipv4").val(result["ipv4"]);
            $("#me_ipv6").val(result["ipv6"]);
            $("#me_price").val(result["price"]);
            $("#me_bandwidth").val(result["bandwidth"]);
            $("#me_cpu_amount").val(result["cpu"]);
            $("#me_disk").val(result["disk"]);
            $("#me_ram").val(result["ram"]);
            $("#me_swap").val(result["swap"]);
            if (result["tags"] !== null) {
                $("#me_tags").tagsinput('add', result["tags"]);
            }
            if(result['still_have'] == 0){
                $('#me_non_active').prop("checked", true);
            }
            $('#me_owned_since').val(result["owned_since_raw"]);
            $('#me_next_dd').val(result["next_dd"]);
            $("#me_currency").val(result["currency"]);
            $("#me_term").val(result["term"]);
            $("#me_os").val(result["os"]);
...
function modalEditSharedHosting(id) {
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "shared_hosting", "id": id},
        success: function (result) {
            $("#sh_me_server_id").val(result["server_id"]);
            $('#sh_me_hostname').val(result["domain"]);
            $('#sh_me_hostname_header').text(result["domain"]);
            $("#sh_me_price").val(result["price"]);
            $("#sh_me_bandwidth").val(result["bandwidth"]);
            $("#sh_me_storage").val(result["disk_as_gb"]);
            $('#sh_me_owned_since').val(result["owned_since_raw"]);
            $('#sh_me_next_dd').val(result["next_dd"]);
            $("#sh_me_currency").val(result["currency"]);
            $("#sh_me_term").val(result["term"]);
            $("#sh_me_domains_count").val(result["domains_limit"]);
            $("#sh_me_emails").val(result["emails"]);
            $("#sh_me_ftp").val(result["ftp"]);
            $("#sh_me_db").val(result["db"]);
        }
    });
}

function modalEditDomain(id) {
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "domain", "id": id},
        success: function (result) {
            $("#d_me_server_id").val(result["server_id"]);
            $('#d_me_hostname').val(result["domain"]);
            $('#d_me_hostname_header').text(result["domain"]);
            $("#d_me_price").val(result["price"]);
            $('#d_me_owned_since').val(result["owned_since_raw"]);
            $('#d_me_next_dd').val(result["next_dd"]);
            $("#d_me_currency").val(result["currency"]);
...
function yabsModalView(hostname, id) {
    ...
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "yabsModal", "id": id},
        success: function (result) {
            $("#yabsModalBody").append(result);
            $("#yabs_hostname_header").text(hostname);
        }
    });
}
...
$('#searchInput').keyup(delay(function (e) {
    ...
    $.ajax({
        type: "GET",
        url: "calls.php",
        data: {"type": "search", "value": search_term},
        success: function (result) {
